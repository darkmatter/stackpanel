#!/usr/bin/env bash
# ==============================================================================
# Auto-generated entrypoint for server
...
#
#   source packages/scripts/entrypoints/server.sh --dev
#   bun run dev
#
# Or inline:
#   source packages/scripts/entrypoints/server.sh --dev && bun run dev
# ==============================================================================
...
export STACKPANEL_APP_NAME="server"
export STACKPANEL_APP_PATH="apps/server"
...
log_debug "Entrypoint complete - environment ready for server"
