...
//
// Environment variables used by this package are defined in the envvars package.
// See packages/stackpanel-go/envvars/envvars.go for the centralized registry.
package state
...
func findStateFile() string {
	...
	// Using envvars package for consistent variable access
	if path := envvars.StackpanelStateFile.Get(); path != "" {
	...
	if dir := envvars.StackpanelStateDir.Get(); dir != "" {
