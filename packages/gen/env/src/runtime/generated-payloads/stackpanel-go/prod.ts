...
const encryptedPayload = {
  "STACKPANEL_TEST_PAIRING_TOKEN": "ENC[AES256_GCM,data:ZFx+7nGyALY=,iv:pz7FjxGdt55XPk5++QWa6YhKkCBgtUWXPyILcTFq6B4=,tag:RBRLXn1ata5MMkcoK4wv/g==,type:str]",
  "sops": {
    "age": [
      {
    ...
    "mac": "ENC[AES256_GCM,data:JvO16C/5m4rkDpv/fkp9HxPox1jvex6pnmDudp3jul9/OxIqS5lKWTCV4/8DhilM/Sl81btOklPcdt0cW1kEps9XoRM35Dj5utcua/BO60Zb0Hl7143+s3fH2pxAe7D+4iraU1V7NSVXcSoIxBBxwqzG1roF8ukHwL7tudSUPVQ=,iv:VShLv6qBUhWoYQn+O9Z+9cbY6d89BDGQERxluNpZM4g=,tag:/yfGdGfXwO0JRUAJl9MS/A==,type:str]",
