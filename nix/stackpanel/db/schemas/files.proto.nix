...
proto.mkProtoFile {
  ...
  messages = {
    ...
    GeneratedFile = proto.mkMessage {
      ...
      fields = {
        path = proto.withExample ".stack/gen/ide/vscode/settings.json" (proto.string 1 "Relative path from project root where file will be written");
        type = proto.message "FileType" 2 "Type of content source (text or derivation)";
        enable = proto.withExample true (proto.bool 3 "Whether this file should be generated");
        mode = proto.optional (proto.withExample "0644" (proto.string 4 "File permissions (e.g., '0755')"));
        source = proto.optional (proto.withExample "stackpanel.ide.vscode" (proto.string 5 "Module or component that generated this file"));
        description = proto.optional (proto.withExample "VS Code workspace settings generated by the IDE module" (proto.string 6 "Human-readable description of the file's purpose"));
        store_path = proto.optional (
          proto.withExample "/nix/store/abc123-vscode-settings/settings.json" (proto.string 7 "Nix store path containing the file content (for derivation type)")
        );
        text = proto.optional (
    ...
    GeneratedFiles = proto.mkMessage {
      ...
      fields = {
        enable = proto.withExample true (proto.bool 1 "Whether file generation is enabled globally");
