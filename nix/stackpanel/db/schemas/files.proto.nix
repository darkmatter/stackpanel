...
proto.mkProtoFile {
  ...
  messages = {
    ...
    GeneratedFile = proto.mkMessage {
      ...
      fields = {
        path = proto.withExample ".stack/gen/ide/vscode/settings.json" (
          proto.string 1 "Relative path from project root where file will be written"
        );
        ...
        source = proto.optional (
          proto.withExample "stackpanel.ide.vscode" (
            proto.string 5 "Module or component that generated this file"
          )
        );
        description = proto.optional (
          proto.withExample "VS Code workspace settings generated by the IDE module" (
            proto.string 6 "Human-readable description of the file's purpose"
          )
        );
        store_path = proto.optional (
          proto.withExample "/nix/store/abc123-vscode-settings/settings.json" (
    ...
    GeneratedFiles = proto.mkMessage {
      ...
      fields = {
        ...
        } (proto.map "string" "GeneratedFile" 2 "Map of file path to file configuration");
      };
    };
  };
}
