...
let
  ...
  # NOTE: Do NOT compute appsWithCommands etc. here at the top-level let block.
  # Accessing cfg.apps here causes infinite recursion with appModules.
  # All app-related computations are done lazily inside the config block below.

in
{
  # ===========================================================================
  # Options - extend app schema with commands
  # ===========================================================================
  config = lib.mkMerge [
