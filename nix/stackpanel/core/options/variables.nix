...
#   "/dev/DATABASE_URL" = { value = "ref+sops://.stackpanel/secrets/vars/dev.sops.yaml#/DATABASE_URL"; };
#   "/prod/API_KEY" = { value = "ref+sops://.stackpanel/secrets/vars/prod.sops.yaml#/API_KEY"; };
#   "/computed/apps/web/port" = { value = "3000"; };  # Read-only
#
# Keygroups (ID prefix):
#   /var/*      - Shared config (plaintext in vars/var.sops.yaml with # safe marker, NOT encrypted)
#   /dev/*      - Dev secrets (encrypted in vars/dev.sops.yaml)
#   /staging/*  - Staging secrets (encrypted in vars/staging.sops.yaml)
#   /prod/*     - Production secrets (encrypted in vars/prod.sops.yaml)
#   /computed/* - Generated by Nix modules (read-only)
#
# Values can be:
#   - Literal strings: "3000", "postgresql://localhost/dev"
#   - SOPS refs: "ref+sops://.stackpanel/secrets/vars/dev.sops.yaml#/KEY"
#   - YAML refs: "ref+yaml://.stackpanel/secrets/vars/var.sops.yaml#/KEY"
  ...
  options.stackpanel.variables = lib.mkOption {
    ...
    description = ''
      ...
      Values are either literal strings or vals references:
        ...
        "ref+yaml://.../vars/var.sops.yaml#/LOG_LEVEL"   (plaintext YAML)
