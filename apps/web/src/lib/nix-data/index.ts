...
/**
 * Entity types available in .stack/data/
 */
export type Entity =
	| "apps"
	| "aws"
...
/**
 * Read an entity from .stack/data/{entity}.nix
...
export async function read<T>(
	...
	const raw = await nixEval(`import ./.stack/data/${entity}.nix`);
	return kebabToSnake(raw) as T;
}

/**
 * Write an entity to .stack/data/{entity}.nix
...
${jsonToNix(nixData)}
`;
	await writeFile(`.stack/data/${entity}.nix`, content);
}
