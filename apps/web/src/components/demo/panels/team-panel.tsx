          ...
          <DialogContent>
            ...
            <div className="grid gap-4 py-4">
              <div className="grid gap-2">
                ...
                <Input id="email" placeholder="colleague@acme.com" type="email" />
              </div>
              <div className="grid gap-2">
                <Label>Role</Label>
              ...
              <div className="rounded-lg border border-border bg-secondary/30 p-3">
                <p className="text-muted-foreground text-sm">
                  The invited member will receive an email with SSO login instructions.
                  Once they log in, they'll be prompted to add their age public key for
                  secrets access.
                </p>
              </div>
            </div>
