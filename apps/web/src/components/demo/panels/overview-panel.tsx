          ...
          return (
            ...
            >
              <CardContent className="p-6">
                ...
                <p className="mt-2 text-muted-foreground text-xs">{stat.change}</p>
              </CardContent>
            </Card>
          );
        })}
