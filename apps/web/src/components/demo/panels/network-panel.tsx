        ...
        <TabsContent className="mt-6 space-y-4" value="devices">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <CardTitle className="font-medium text-base">Connected Devices</CardTitle>
            ...
            <CardContent className="flex items-center gap-4 p-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground text-xs">
                  Certificates are automatically issued to all machines and team members
                  via the internal CA.
                </p>
              </div>
            ...
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-muted-foreground text-sm">
                  Search domain: <code className="text-accent">internal.acme.com</code>
                </p>
              </div>
              <Button size="sm" variant="outline">
                Add Record
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-xs">{record.target}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <code className="text-muted-foreground text-sm">{record.ip}</code>
                      <Button className="h-8 w-8" size="icon" variant="ghost">
