  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="font-semibold text-foreground text-xl">Services</h2>
          <p className="text-muted-foreground text-sm">
            Manage your deployed services and infrastructure
          </p>
        </div>
        <Dialog onOpenChange={setDialogOpen} open={dialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Deploy a new service from your GitHub repository or a custom image.
              </DialogDescription>
            </DialogHeader>
              ...
              <div className="grid gap-2">
                ...
                <Select>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="frontend">acme-corp/frontend</SelectItem>
                    <SelectItem value="workers">acme-corp/workers</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="grid gap-2">
                ...
                <div className="flex min-w-0 flex-1 items-center gap-4">
                  <div
                    className={`h-3 w-3 rounded-full ${
                      service.status === "running" ? "bg-accent" : "bg-muted-foreground"
                    }`}
                  />
