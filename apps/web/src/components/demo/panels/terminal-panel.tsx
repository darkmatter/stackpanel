...
const commandResponses: Record<string, TerminalLine[]> = {
  help: [
    ...
    {
      type: "output",
      content: "  create-app <name>     Create a new app with turborepo template",
    },
    {
      type: "output",
    ...
    <div className="space-y-6">
      ...
      <Card className={isFullscreen ? "fixed inset-4 z-50 flex flex-col" : ""}>
        <div className="flex items-center justify-between border-border border-b bg-secondary/50 px-2">
          ...
          <Button className="h-8 w-8" onClick={addTab} size="icon" variant="ghost">
            <Plus className="h-4 w-4" />
          </Button>
        </div>

        <CardContent className={`flex-1 p-0 ${isFullscreen ? "overflow-hidden" : ""}`}>
          <div
      ...
      <Card>
        <CardContent className="p-4">
          <p className="mb-3 text-muted-foreground text-sm">Try these commands:</p>
