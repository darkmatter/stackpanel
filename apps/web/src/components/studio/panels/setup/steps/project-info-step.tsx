	...
	const keyLocations: KeyLocation[] = [
		{
			...
			path: dataPath,
			description:
				"Your Stackpanel configuration. Edit these Nix files to customize your setup, secrets schemas, and project settings.",
			icon: Settings,
		...
		},
		{
			...
			path: genPath,
			description:
				"Auto-generated files from Nix. These are rebuilt when you enter the devshell. Check them in for IDE support without running Nix.",
			icon: Folder,
		...
		},
		{
			...
			path: statePath,
			description:
				"Runtime state like current configuration snapshot. Rebuilt each shell entry. Not tracked in git.",
			icon: Database,
		...
		},
		{
			...
			path: homeDirPath,
			description:
				"User-specific secrets like your AGE private key. Located in your home directory, never committed to git.",
			icon: Home,
