...
export function VscodeSection({ config }: VscodeSectionProps) {
  const isWorkspaceMode = config.vscodeOutputMode === "workspace";
  ...
  return (
    <Card className={config.ideEnabled ? "" : "opacity-95"}>
      <CardHeader className="space-y-2 pb-4">
        ...
        <CardDescription>
          Configure how VS Code settings are generated and shared with your team
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-8">
        <div className="space-y-4">
          ...
          <div className="flex items-start justify-between gap-4 rounded-xl border bg-muted/50 px-5 py-4">
            <div className="space-y-1">
              <p className="text-sm font-medium leading-6">VS Code workspace</p>
              <p className="text-sm text-muted-foreground">
        ...
        {config.vscodeEnabled && (
          <div className="space-y-4 rounded-xl border px-5 py-5">
            <div className="space-y-1">
              <h4 className="text-sm font-semibold">Settings output location</h4>
              <p className="text-sm text-muted-foreground">
                Choose where VS Code settings (nixd options, formatters, etc.)
                are generated.
              </p>
            </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      . Open the workspace file in VS Code to use the generated
                      settings.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-start gap-2 rounded-lg border border-amber-500/40 bg-amber-500/10 px-3 py-2 text-amber-700 dark:text-amber-300">
                      ...
                      <p className="text-sm leading-5">
                        Regenerates on each devshell entry. Manual edits will be
                        overwritten—use the workspace file to keep custom
                        settings.
                      </p>
                    </div>
                  </div>
