        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-pretty text-lg text-muted-foreground leading-relaxed">
              From idea to production-ready app. StackPanel unifies infrastructure,
              tooling, secrets, and local development into one internal platform your
              ...
              <div className="p-4">
                <div className="mb-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-foreground text-sm">acme-corp</p>
                ...
                <div className="mt-4 rounded-lg bg-background p-3 font-mono text-xs">
                  ...
                  <div className="text-accent">✓ Applied stack configuration</div>
