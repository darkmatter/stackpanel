...
Use 'stack preflight run' for safe entry tasks like host-side code generation.
Use 'stack preflight import-env' to explicitly materialize environment values
...
func generateNixConfig(cfg envConfig) string {
	...
	sb.WriteString("# Generated by: stack preflight import-env\n")
	sb.WriteString("#\n")
	sb.WriteString(
		"# This file materializes environment variables into Nix configuration,\n",
	)
	sb.WriteString("# enabling pure mode evaluation (nix develop without --impure).\n")
	sb.WriteString("#\n")
	sb.WriteString("# To regenerate: stack preflight import-env --force\n")
