...
Services are orchestrated by [process-compose](https://github.com/F1bonacc1/process-compose), a lightweight process manager. When you run `stack services start`, process-compose launches all enabled services, respects dependency ordering, runs health checks, and streams logs.
