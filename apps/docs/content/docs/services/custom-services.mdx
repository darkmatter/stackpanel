...
When you start services with `stack services start`, your custom service starts alongside the built-in ones—with dependency ordering respected.
...
stack logs my-worker

# Follow logs in real-time
stack logs my-worker -f
...
stack services start api worker   # Start specific services
stack services stop               # Stop all services
stack services restart api        # Restart a specific service
stack services status             # Show status of all services
```
