...
The `stack services` command wraps Process Compose with project-aware defaults:
...
stack services restart postgres
...
5. Registers CLI commands (`stack services start postgres`, etc.)
