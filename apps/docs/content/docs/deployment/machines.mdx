...
<Callout type="info">
For the canonical deployment/provisioning contract, including `stackpanel.deployment.machines`, `stack deploy`, and `stack provision`, see `docs/superpowers/specs/2026-03-28-deployment-system.md` in the repository. This page focuses on machine-inventory and infrastructure-facing workflows.
</Callout>
...
Deploy tooling (`stack deploy`, `stack provision`, colmena wrappers)
