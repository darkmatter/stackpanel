---
title: Cloudflare Workers Deployment App Configuration Schema
description: "Unified field definitions for Cloudflare Workers per-app deployment configuration."
---
