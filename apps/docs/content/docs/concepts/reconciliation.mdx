...
description: How stack doctor and stack setup keep a repo converged, and which surface a change belongs in
icon: refresh-cw
---
...
- [`stack doctor`](/docs/cli/doctor) reports. Never prompts, never writes.
- [`stack setup`](/docs/cli/setup) shows the same report, then confirms, then applies.
