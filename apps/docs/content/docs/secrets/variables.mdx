...
```bash
# Set a literal value
stack vars set DATABASE_URL --value "postgresql://localhost:5432/dev"

# Set an encrypted secret
stack vars set API_KEY --value "sk-abc123" --secret --keys dev,prod

# Get a value (decrypts if needed)
stack vars get API_KEY

# List all variables
stack vars list

# Delete a variable
stack vars delete API_KEY
```
