...
For example, with prefix "darkmatter/stackpanel" and a variable /dev/DATABASE_URL: chamber write darkmatter/stackpanel/dev DATABASE_URL \<value\> chamber exec darkmatter/stackpanel/dev -- \<command\>
