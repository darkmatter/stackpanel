...
The deprecated [`moduleChecks`](/docs/reference/checks) and
[`healthchecks.modules`](/docs/reference/healthchecks) options still work and
write into this option; their computed outputs are byte-identical read-only views.
