...
- **Stackpanel Studio** - A web interface with a registry of extensions, allowing you to easily add Nix capabilities to your environment with a single click.

Together, we hope these tools will bring the amount of work about work you do closer to zero:
