...
PROJECT_ROOT=/Users/cm/git/darkmatter/stackpanel/apps/stackpanel-go
...
export SOPS_AGE_KEY_CMD="${SOPS_AGE_KEY_CMD:-/nix/store/yywcv8gc114m8g26knn3yjja087w5kal-sops-age-keys/bin/sops-age-keys}"
