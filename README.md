...
aws-generate-config .stackpanel/state/aws/config

# In docker-compose.yml, mount:
volumes:
  - ./.stackpanel/state/step:/certs:ro
  - ./.stackpanel/state/aws/config:/root/.aws/config:ro

# Set env vars in container for the paths
environment:
